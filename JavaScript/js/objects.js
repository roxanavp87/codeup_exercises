(function(){
    ...
    shoppers.forEach(function (shopper) {
        var finalPayment = shopper.amount;
        if(shopper.amount > 200) {
            finalPayment = shopper.amount*0.65;
        }
        console.log(shopper.name + " bought $" + shopper.amount.toFixed(2) + " worth of products. Final payment: $" + finalPayment.toFixed(2));
    });
